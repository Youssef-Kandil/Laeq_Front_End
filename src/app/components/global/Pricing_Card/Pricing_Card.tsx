...
function Pricing_Card({
  ...
  const sortedFeatures = arrayOfFeatures.sort((a, b) => {
    const aAvailable = featureMap[a] !== undefined;
    const bAvailable = featureMap[b] !== undefined;
  
    // اللي مش موجود يروح تحت
