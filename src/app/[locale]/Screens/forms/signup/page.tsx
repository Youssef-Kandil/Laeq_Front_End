...
function Signup() {
 ...
 const { mutate, isPending,isError,error } = useAdminAccount();
  ...
  return (
    <div className={Styles.parent} >
      ...
      <div className={Styles.form} dir={current_lang === "ar" ? "rtl" : "ltr"}>
              ...
              <motion.div
                 ...
                 >
                  {/* === Form Headers */}
                    ...
                    <div className={Styles.google_signup} onClick={()=>signIn("google")}>
        ...
        {/* === Alert Message === */}
        {alertState?
          <Stack sx={{ width: '90%',textAlign:'start'}} spacing={2}>
