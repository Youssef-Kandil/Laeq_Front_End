...
function Invoice_Details() {
  ...
  return(
      ...
      <nav className={Styles.navRow2}>
          ...
          <div className={Styles.nav_details}>
            <p>Amount Before VAT</p>
            <span>{(Number(data.amount)/1.15).toFixed(2)}<Image src={"/price.svg"} alt='' width={30} height={30}/></span>
          </div>
          <div className={Styles.nav_details}>
            <p>VAT</p>
            <span>{(Number(data.amount)-(Number(data.amount)/1.15)).toFixed(2)}<Image src={"/price.svg"} alt='' width={30} height={30}/></span>
          </div>
          <div className={Styles.nav_details}>
